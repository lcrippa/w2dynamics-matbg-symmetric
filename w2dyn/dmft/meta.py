...
QUANTITIES = {
    ...
    "gtau-ft": dict(
        axes=["ineq", "band", "spin", "tau"],
        desc="impurity Green's function on the imaginary time axis [0, beta] (from Fourier transform)"
    ),
    "stau-ft": dict(
        axes=["ineq", "band", "spin", "tau"],
        desc="impurity self-energy with Green's functions moments -(Sigma - Sigma_0)/Sigma_1 on the imaginary time axis [0, beta] (from Fourier transform)"
    ),
    "stau-aux0": dict(
        axes=["ineq", "band", "spin", "tau"],
        desc="Auxiliary Green's functions 1/(i*omega - Sigma + Sigma_0) on the imaginary time axis [0, beta]"
    ),
    "stau-auxmu": dict(
        axes=["ineq", "band", "spin", "tau"],
        desc="Auxiliary Green's functions 1/(i*omega - Sigma + Sigma_0 + mu) on the imaginary time axis [0, beta]"
    ),
    "gtau-blocks": dict(
    ...
    "raman-worm": dict(
        axes=["ineq", "iwb1", "iwb2"],
        desc="Raman diagram from worm sampling"
        ),
    "occ": dict(
        axes=["ineq", "band1", "spin1", "band2", "spin2"],
        desc="Occupancies"
    ...
    "next-mu": dict(
        desc="unmixed proposed chemical potential for next iteration (lattice model)"
        ),
    "used-udd": dict(
        desc="actual value of Udd used in iteration when search is active"
        ),
    "lda-mu": dict(
